...
public class Constants {
    private static final Config specsConfig = ConfigFactory.parseFile(new File("src/main/resources/configuration/part5/Datacenter1/cloudspecs.conf"));
    private static final Config servicesConfig = ConfigFactory.parseFile(new File("src/main/resources/configuration/part5/Datacenter1/services.conf"));
